          ...
          <div class="advContent">
            ...
            <div class="contentItem">
              <ul class="noticeList">
                <li>
                  <div class="item">
                    <img src="@/assets/common/head2.jpg" alt="">
                    <div>
                      <p>
                        <span class="col1">朱锁锁</span> 发布了
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/head3.jpg" alt="">
                    <div>
                      <p>
                        <span class="col2">文吉星</span> 发布了
                ...
                <li>
                  <div class="item">
                    <img src="@/assets/common/head1.jpg" alt="">
                    <div>
                      <p>
                        <span class="col3">瞿光明</span> 发布了
      ...
      <el-col :span="11">
        ...
        <el-card class="box-card">
          ...
          <div class="sideNav">
            ...
            <el-button class="sideBtn">考勤查询</el-button>
            <el-button class="sideBtn">考勤统计</el-button>
            <el-button class="sideBtn">组织架构</el-button>
          </div>
        </el-card>
...
.sideLink {
  ...
  .icon2 {
    ...
    width: 76px;
    height: 76px;
    background: url("./../../assets/common/head2.jpg") no-repeat;
  }
  .icon3 {
    display: inline-block;
    width: 76px;
